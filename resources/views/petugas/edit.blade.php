                        ...
                        <form action="{{ route('petugas.update', $petugas[0]->id)}}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="id" id="id" placeholder="Masukan ID" value="{{ $petugas[0]->id }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="jabatan_petugas" id="judul" placeholder="" value="{{ $petugas[0]->jabatan_petugas }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="tlp_petugas" data-inputmask='"mask": "(999) 999-9999"' data-mask placeholder="Masukan angka" value="{{ $petugas[0]->tlp_petugas }}">
                                    </div>
                                </div>
